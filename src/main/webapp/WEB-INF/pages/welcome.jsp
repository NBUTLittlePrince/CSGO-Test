                                ...
                                <div class="welcome-module">
                                    <div class="layui-row layui-col-space10 layuimini-qiuck">
                                        <div class="layui-col-xs3 layuimini-qiuck-module">
                                            <a href="javascript:;" layuimini-content-href="typeIndex" data-title="武器类型管理" data-icon="fa fa-window-maximize">
                                                <i class="fa fa-window-maximize"></i>
                                                <cite>武器类型管理</cite>
                                            </a>
                                        </div>
                                        <div class="layui-col-xs3 layuimini-qiuck-module">
                                            <a href="javascript:;" layuimini-content-href="transactionIndex" data-title="交易管理" data-icon="fa fa-gears">
                                        ...
                                        <div class="layui-col-xs3 layuimini-qiuck-module">
                                            <a href="javascript:;" layuimini-content-href="userIndex" data-title="用户管理" data-icon="fa fa-dot-circle-o">
                    ...
                    series : [
                        {
                            ...
                            data:[
                                ...
                                {value:${type.counts}, name:'${type.weapontypename}'},
                                </c:forEach>
                                ,0
                            ],
                            roseType: 'angle',
